...
1. 使用system登录到pdborcl,授予MiracleVin三个分区权限

>sqlplus system/123@localhost/pdborcl

```sql
ALTER USER MiracleVin QUOTA UNLIMITED ON USERS;
ALTER USER MiracleVin QUOTA UNLIMITED ON USERS02;
