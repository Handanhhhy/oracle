/*
实验三脚本文件:
首先创建自己的账号MiracleVin，然后以system身份登录:

[student@deep02 ~]$sqlplus system/123@localhost/pdborcl
SQL>ALTER USER MiracleVin QUOTA UNLIMITED ON USERS;
SQL>ALTER USER MiracleVin QUOTA UNLIMITED ON USERS02;
SQL>ALTER USER MiracleVin QUOTA UNLIMITED ON USERS03;
SQL>exit

然后以自己的账号MiracleVin身份登录,并运行脚本文件test3.sql:
[student@deep02 ~]$cat test3.sql
[student@deep02 ~]$sqlplus MiracleVin/123@localhost/pdborcl
SQL>@test3.sql
SQL>exit
...
select * from MiracleVin.orders where order_date
between to_date('2017-1-1','yyyy-mm-dd') and to_date('2018-6-1','yyyy-mm-dd');

select a.ORDER_ID,a.CUSTOMER_NAME,
b.product_name,b.product_num,b.product_price
from MiracleVin.orders a,MiracleVin.order_details b where
