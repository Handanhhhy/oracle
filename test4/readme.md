...
datafile
'/home/student/dhd/pdbtest_users02_1.dbf'
  SIZE 100M AUTOEXTEND ON NEXT 256M MAXSIZE UNLIMITED,
'/home/student/dhd/pdbtest_users02_2.dbf'
  SIZE 100M AUTOEXTEND ON NEXT 256M MAXSIZE UNLIMITED
...
### 给用户user1授予表空间Users04的使用权限

```sql
ALTER USER user1 QUOTA UNLIMITED ON USERS04;
```
![GrantToUser1](./GrantToUser1.png)
...
### 创建表 DEPARTMENTS、EMPLOYEES、PRODUCTS、ORDER_ID_TEMP、ORDERS
...
1. 以下时间在 0.02 秒以内为正常：(id 取值从 1 到 20000000)
...
![特殊查询语句-分区表](./特殊查询语句1.png)
![特殊查询语句-分区索引](./特殊查询语句2.png)
4. 查询一个分区中的数据
```sql
--查询一个分区中的数据
...
![查询一个分区中的数据](./查询一个分区中的数据1.png)
![查询一个分区中的数据](./查询一个分区中的数据2.png)
5. 统计用户的所有表
```sql
--查询一个分区中的数据
